...
const edadPar = ages1.filter( age => age % 2===0)
console.log(edadPar);
...
const streamersConU = streamers1.filter(streamer => streamer.name.toLowerCase().includes('u'))
