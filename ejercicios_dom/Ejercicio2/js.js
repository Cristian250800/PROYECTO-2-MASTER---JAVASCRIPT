...
for (let index = 0; index < 6; index++) {
    ...
    DivLoop.appendChild(nuevoPLoop);
...
pNuevo.textContent = 'Voy en medio!';
const primerDiv = document.querySelector('div');

primerDiv.after(pNuevo);

//2.9 Inserta p con el texto 'Voy dentro!', dentro de todos los div con la clase .fn-insert-here

const nuevoP = document.querySelectorAll(".fn-insert-here")

nuevoP.forEach(element => {
