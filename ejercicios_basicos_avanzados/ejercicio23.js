...
for (const movie of movies) {
   if ( movie.durationInMinutes < 100){
    peliCorta.push(movie);
   } 
   else if (movie.durationInMinutes >= 100 && movie.durationInMinutes < 200){
    peliMedia.push(movie);
   } 
   else {
    peliLarga.push(movie)
   }
}


console.log("Películas cortas: " , peliCorta)
console.log("Películas medianas: " , peliMedia)
console.log("Películas largas: " , peliLarga)