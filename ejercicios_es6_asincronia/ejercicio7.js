...
const filtradoRPG = videogames.filter( game => game.genders.includes('RPG'))
const sumaScore = filtradoRPG.reduce((acc, game) => acc + game.score, 0)
const promedio = sumaScore / filtradoRPG.length
console.log(filtradoRPG, promedio);